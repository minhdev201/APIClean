...
namespace ApiMES.Migrations
{
    ...
    [Migration("20250520064106_AddRefreshTokenTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiMES.Application.DTOs.CheckTCodeDTO", b =>
                {
                    ...
                    b.ToTable("CheckTCodeDTO");
                });

            modelBuilder.Entity("ApiMES.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ApiMES.Domain.Entities.MenuItem", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ApiMES.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApiMES.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("ApiMES.Domain.Entities.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApiMES.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
